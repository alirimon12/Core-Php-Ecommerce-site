...

{
   $type=$_GET['type'];
    ...
    $DeleteCat="DELETE from dish where id='$id' ";
...
$updateStatus="UPDATE dish set status='$status' where id=' $id' ";  
...
$SelectaCat="SELECT dish.*, category.category from dish, category where dish.category_id=category.id";  
...
?>
   <div class="card">
            ...
            <a href="dish_master.php"><h4 class="card-title">Category Master</h4></a>
            ...
            while($row=mysqli_fetch_assoc($res))
                ...
                ?>
                        ...
                        ?>
                            <a href="dish_master.php?id=<?php echo $row['id']?>"><label class="badge badge-primary">Edit</label></a>
